...
export const api = {
  ...
  markSession: (code, latitude, longitude, deviceFingerprint) => request('/student/attendance/mark/', { method: 'POST', body: JSON.stringify({ code, latitude, longitude, device_fingerprint: deviceFingerprint }) }),
